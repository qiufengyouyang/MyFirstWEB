...
/**
 * @author zhangning 2016年8月1日 单例对象（Singleton）是一种常用的设计模式。在Java应用中，
...
public class Singleton {
	...
	// 方式一 getInstance方法加synchronized关键字，
	 ...
	 * 但是，这样的情况，还是有可能有问题的，看下面的情况：在Java指令中创建对象和赋值操作是分开进行的， 也就是说instance = new
